...
import 'package:robotxp_dashboard/app/widgets/rename_dialog.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<void> openEditTrajectory(BuildContext context) async {
    final result = await showDialog<bool>(
      context: context,
      builder: (context) => const RenameDialog(),
    );
    print((store.filter as TrajectoryFilterModel).trajectory.name);
    print((store.filter as TrajectoryFilterModel).trajectory.title);
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            // if (store.filter is TrajectoryFilterModel) ...[
                            //   const SizedBox(width: 4),
                            //   IconButton(
                            //     onPressed: () => openEditTrajectory(context),
