...
mixin _$HomeStore on _HomeStoreBase, Store {
  Computed<int>? _$trajSkipComputed;

  @override
  int get trajSkip => (_$trajSkipComputed ??=
          Computed<int>(() => super.trajSkip, name: '_HomeStoreBase.trajSkip'))
      .value;
  ...
  late final _$trajPageAtom =
      Atom(name: '_HomeStoreBase.trajPage', context: context);

  @override
  int get trajPage {
    _$trajPageAtom.reportRead();
    return super.trajPage;
  }

  @override
  set trajPage(int value) {
    _$trajPageAtom.reportWrite(value, super.trajPage, () {
      super.trajPage = value;
    });
  }

  late final _$trajTakeAtom =
      Atom(name: '_HomeStoreBase.trajTake', context: context);

  @override
  int get trajTake {
    _$trajTakeAtom.reportRead();
    return super.trajTake;
  }

  @override
  set trajTake(int value) {
    _$trajTakeAtom.reportWrite(value, super.trajTake, () {
      super.trajTake = value;
    });
  }
